  ...
  <div class="container mb-1" data-wow-delay="0.1s">
    <div class="row" data-wow-delay="0.1s">
      <div class="col-md-1" style="margin-right: 40px;">
        <a href="/book_data" class="btn btn-primary mb-2" style="border: 1px solid green;">General</a>
      </div>
      <div class="col-md-1">
        <a href="/book_data_final" class="btn mb-2" style="border: 1px solid green;">Final</a>
      </div>
    </div>
  </div>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <?php foreach ($book as $index => $b) : ?>
        <tr>
          <td><?= $index + 1; ?></td>
          <td><img src="/img/<?= $b['cover']; ?>" style="width: 100%;" alt=""></td>
          <td><?= $b['title']; ?></td>
          <td><?= $b['category']; ?></td>
          <td><?= $b['year']; ?></td>
          <td><?= $b['author']; ?></td>
          <td>
            <a href="/edit_general/<?= $b['id_buku']; ?>">
              <button style="
            ...
            <a href="/delete_general/<?= $b['id_buku']; ?>">
